	...
	<div class="container">
		...
		<div <? if ($did_scaffold) echo 'style="display:none"'; ?> id="create_crud">
			<form action="<?= $_SERVER['REQUEST_URI'] ?>" method="post">
				...
				<p>Enter an SQL table dump to generate your pages. <a href="javascript:show_hint()">[Hint]</a></p>
				...
				<p><input type="hidden" name="id_key" id="id_key" value="id" />
					...
					<input type="submit" value="Make pages" />
				</p>
			</form>
		</div>
		<?
